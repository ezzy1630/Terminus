# forge-control mini-service

The **TypeScript control plane** for Forge (SPEC §5, §27, §32). Owns cognition
...
bun mini-services/forge-control/src/index.ts
```
...
Next.js UI (port 3000)
    ...
    ▼
forge-control (port 3050, this service)
    │ privileged effects RPC (http://127.0.0.1:3040)
    ▼
forge-kernel (port 3040, Rust)
```

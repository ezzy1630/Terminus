...
def main() -> int:
    ...
    checks = [
        check_substring(workdir, "src/pipeline.py contains 'class Context'"),
        check_substring(workdir, "src/pipeline.py contains 'Context' in all 5 stage signatures"),
        check_substring(workdir, "src/pipeline.py does not contain 12 individual parameters"),
    ]

    ...
    def main() -> int:
        ...
        checks = [
            check_substring(workdir, 'pyproject.toml requires pydantic>=2.0')
check_substring(workdir, "src/models.py contains 'model_config'")
check_substring(workdir, "src/models.py does not contain 'class Config'")
        ]

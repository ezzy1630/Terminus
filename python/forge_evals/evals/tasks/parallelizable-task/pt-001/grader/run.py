    ...
    def main() -> int:
        ...
        checks = [
            check_substring(workdir, "src/strings.py contains '->' (return type annotation)")
check_substring(workdir, "src/numbers.py contains '->'")
check_substring(workdir, "src/dates.py contains '->'")
check_substring(workdir, "src/paths.py contains '->'")
check_substring(workdir, "src/hashes.py contains '->'")
        ]

    ...
    def main() -> int:
        ...
        checks = [
            check_substring(workdir, 'migrations/sqlite/0002_add_user_email.sql exists')
check_substring(workdir, "migrations/sqlite/0002_add_user_email.sql contains 'email'")
check_substring(workdir, "prisma/schema.prisma contains 'email'")
        ]

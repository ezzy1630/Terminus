    ...
    def main() -> int:
        ...
        checks = [
            check_substring(workdir, "src/handlers/profile.py contains 'fetch_user_data'")
check_substring(workdir, "src/handlers/admin.py contains 'fetch_user_data'")
check_substring(workdir, "src/handlers/profile.py does not contain 'getUserData'")
        ]

...
def main() -> int:
    ...
    checks = [
        check_substring(workdir, "tests/test_parser.py exists"),
        check_substring(workdir, "tests/test_parser.py imports pytest"),
        check_substring(workdir, "tests/test_parser.py defines at least 5 test functions"),
    ]

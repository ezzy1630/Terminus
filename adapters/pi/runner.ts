    ...
    case "run": {
      send({
        ...
        params: {
          ...
          errorMessage: "the real Pi inner harness is not implemented",
          timestamp: nowIso(),
        },
      });
      send({
        ...
        result: {
          status: "blocked",
          summary: "pi adapter unavailable: the real inner harness is not implemented",
          changedFiles: [],
          commit: null,
          tests: [],
          findings: [],
          risks: ["no harness execution or completion evidence exists"],
          unresolved: ["the real Pi inner harness is not implemented"],
          artifacts: [],
          actualBudget: {},
        },
      });

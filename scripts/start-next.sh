...
( setsid bash -c 'cd /home/z/my-project && exec node node_modules/.bin/next dev -p 3000 --webpack' </dev/null >/tmp/forge-next.log 2>&1 & disown ) &
echo "next dev started, log: /tmp/forge-next.log"
sleep 3

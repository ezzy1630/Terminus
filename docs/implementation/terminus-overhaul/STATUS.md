...
3. Add full crash-injection coverage around verification persistence and exercise the live restart path with a completed response artifact and a partially completed plan.

...
| HEAD at last implementation evidence capture | `410685f` (`Measure and ablate retrieval selection`) |
| Branch | `main` |
| Remote state at last implementation evidence capture | Forty-five commits ahead of `origin/main`; no push performed |
| Functional worktree | Functional paths are clean at `410685f`; `SPEC.md` retains a pre-existing user edit |

...
| Declared Rust tests | 601 | `#[test]` + `#[tokio::test]` occurrences in crates/** (excl. generated) |
| TypeScript test files | 169 | `*.test.{ts,tsx}` in packages/ + apps/ |
| Declared TypeScript test blocks | 1602 | `test(/it(` occurrences in those files |
| Declared Python tests | 482 | `def test_*` in python/** |
| ADRs | 54 | docs/decisions/ADR-*.md |

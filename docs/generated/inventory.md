...
| TypeScript test files | 120 | `*.test.{ts,tsx}` in packages/ + apps/ |
| Declared TypeScript test blocks | 945 | `test(/it(` occurrences in those files |
| Declared Python tests | 268 | `def test_*` in python/** |
| ADRs | 51 | docs/decisions/ADR-*.md |
| Runbooks | 15 | docs/runbooks/*.md |
| SQLite migrations | 16 | migrations/sqlite/*.sql |

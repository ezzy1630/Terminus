...
| TypeScript test files | 112 | `*.test.{ts,tsx}` in packages/ + apps/ |
| Declared TypeScript test blocks | 881 | `test(/it(` occurrences in those files |
| Declared Python tests | 262 | `def test_*` in python/** |

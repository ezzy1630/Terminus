...
| TypeScript test files | 95 | `*.test.{ts,tsx}` in packages/ + apps/ |
| Declared TypeScript test blocks | 816 | `test(/it(` occurrences in those files |
| Declared Python tests | 243 | `def test_*` in python/** |
| ADRs | 44 | docs/decisions/ADR-*.md |
| Runbooks | 15 | docs/runbooks/*.md |
| SQLite migrations | 9 | migrations/sqlite/*.sql |

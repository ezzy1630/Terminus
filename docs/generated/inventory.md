...
| Declared Rust tests | 471 | `#[test]` + `#[tokio::test]` occurrences in crates/** (excl. generated) |
| TypeScript test files | 159 | `*.test.{ts,tsx}` in packages/ + apps/ |
| Declared TypeScript test blocks | 1330 | `test(/it(` occurrences in those files |
| Declared Python tests | 282 | `def test_*` in python/** |
| ADRs | 52 | docs/decisions/ADR-*.md |
| Runbooks | 15 | docs/runbooks/*.md |
| SQLite migrations | 22 | migrations/sqlite/*.sql |

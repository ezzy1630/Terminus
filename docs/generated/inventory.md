...
> Auto-generated from Git-tracked source at HEAD by `tools/codegen/inventory.ts`.
...
| Declared Rust tests | 604 | `#[test]` + `#[tokio::test]` occurrences in crates/** (excl. generated) |
| TypeScript test files | 175 | `*.test.{ts,tsx}` in packages/ + apps/ |
| Declared TypeScript test blocks | 1678 | `test(/it(` occurrences in those files |

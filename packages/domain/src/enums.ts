...
export const TURN_TRANSITIONS: Readonly<Record<TurnState, readonly TurnState[]>> = {
  PENDING: ["CONTEXT_COMPILING", "REPAIRING", "INTERRUPTED", "ABORTED", "FAILED"],
  CONTEXT_COMPILING: ["PROVIDER_RUNNING", "INTERRUPTED", "ABORTED", "FAILED", "BUDGET_EXHAUSTED", "POLICY_DENIED"],
  PROVIDER_RUNNING: ["RESPONSE_VALIDATING", "INTERRUPTED", "ABORTED", "FAILED", "BUDGET_EXHAUSTED"],
  RESPONSE_VALIDATING: ["TOOL_SETTLEMENT", "PROVIDER_RUNNING", "VERIFYING", "FINALIZING", "INTERRUPTED", "ABORTED", "FAILED"],
  TOOL_SETTLEMENT: ["CONTEXT_COMPILING", "PROVIDER_RUNNING", "FINALIZING", "INTERRUPTED", "ABORTED", "FAILED", "POLICY_DENIED"],
  VERIFYING: ["REPAIR_PENDING", "VERIFIED", "BLOCKED", "USER_ACTION_REQUIRED", "INTERRUPTED", "ABORTED", "FAILED"],
  REPAIR_PENDING: ["REPAIRING", "BLOCKED", "USER_ACTION_REQUIRED", "ABORTED", "FAILED"],
  REPAIRING: ["CONTEXT_COMPILING", "VERIFYING", "BLOCKED", "INTERRUPTED", "ABORTED", "FAILED"],
  VERIFIED: ["FINALIZING", "ABORTED", "FAILED"],
  FINALIZING: ["COMPLETED", "ABORTED", "FAILED"],
  COMPLETED: [],
  INTERRUPTED: ["PENDING", "REPAIRING", "FAILED"],
  BLOCKED: ["PENDING", "REPAIRING", "FAILED"],
  USER_ACTION_REQUIRED: ["PENDING", "FAILED"],

...
///
/// The store roots at `$TERMINUS_DATA/artifacts/` (or any directory passed to
...
mod tests {
    ...
    fn update_metadata_writes_both_stores() {
        ...
        assert_eq!(
            fetched.retention_class,
            crate::metadata::RetentionClass::Audit
        );
